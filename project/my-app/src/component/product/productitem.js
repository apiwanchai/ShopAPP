...
class Productitem extends Component {
    ...
    render(){
        const stype={height:400};
        const { loading } = this.state;
        const {productName,untiPrice,thumbnail}= this.props.product ;
        return (<div className= "col-mdu-3 col-sm-6" >
            <img className="img-fluid img-thumbnail mx-auto  "  style = {stype}  src={thumbnail} alt="ruryyyj"  />
            ...
            <button className="btn btn-block btn-secondary title " size="lg" value ={untiPrice} disabled={loading} 
